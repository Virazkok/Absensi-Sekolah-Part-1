...
const EditProfile: React.FC = () => {
  ...
  useEffect(() => {
    axios.get("/api/student/me").then((res) => {
      setUser(res.data);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post("/api/student/update-profile", formData, {
  ...
  return (
    <div className="max-w-sm mx-auto bg-white min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-5 text-gray-900">
        {/* Biodata */}
        <div>
          <h2 className="font-semibold mb-2 text-base">Biodata</h2>
        ...
        <div className="space-y-2">
          ...
          <button
            type="button"
            onClick={() => router.visit("/murid/home")}
